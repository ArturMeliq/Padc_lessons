    ...
    [Symbol.iterator]() {
        ...
        return {
            next() {
                ...
                console.log(i < values.length, 111111);
                console.log(typeof values[i + 1] !== "undefined", 222222);
                console.log(typeof values[i + 2] === "undefined", 333333);
                console.log((typeof values[i + 2]));
